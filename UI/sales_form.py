...
class Ui_Dialog_sales_form(object):
    def setupUi(self, Dialog_sales_form):
        ...
        Dialog_sales_form.resize(531, 306)
        icon = QIcon()
        ...
        self.verticalLayoutWidget_5.setGeometry(QRect(10, 10, 511, 251))
        ...
        self.cantidadVendidaSpinBox = QSpinBox(self.verticalLayoutWidget_5)
        self.cantidadVendidaSpinBox.setObjectName(u"cantidadVendidaSpinBox")

        self.formLayout_sales.setWidget(2, QFormLayout.FieldRole, self.cantidadVendidaSpinBox)
