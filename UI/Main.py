...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionCelulares_2 = QAction(MainWindow)
        self.actionCelulares_2.setObjectName(u"actionCelulares_2")
        self.actionZapatos_2 = QAction(MainWindow)
        self.actionZapatos_2.setObjectName(u"actionZapatos_2")
        self.actionBisuteria = QAction(MainWindow)
        self.actionBisuteria.setObjectName(u"actionBisuteria")
        ...
        self.actionExportar_tabla_actual_hacia_CSV = QAction(MainWindow)
        self.actionExportar_tabla_actual_hacia_CSV.setObjectName(u"actionExportar_tabla_actual_hacia_CSV")
        self.actionExportar_tabla_actual_hacia_CSV.setShortcutContext(Qt.WindowShortcut)
        ...
        self.horizontalLayoutWidget.setGeometry(QRect(10, 10, 1291, 31))
        ...
        self.verticalLayoutWidget_16.setGeometry(QRect(10, 60, 681, 388))
        ...
        self.verticalLayoutWidget_7.setGeometry(QRect(710, 150, 391, 120))
        ...
        self.verticalLayoutWidget_6.setGeometry(QRect(710, 60, 391, 80))
        ...
        self.verticalLayoutWidget_13.setGeometry(QRect(10, 10, 371, 224))
        ...
        self.verticalLayoutWidget.setGeometry(QRect(660, 170, 601, 191))
        ...
        self.label_45.setGeometry(QRect(10, 140, 251, 21))
        ...
        self.pushButton.setGeometry(QRect(730, 80, 171, 25))
        self.dateEdit = QDateEdit(self.tab_3)
        self.dateEdit.setObjectName(u"dateEdit")
        self.dateEdit.setGeometry(QRect(930, 380, 110, 26))
        self.dateEdit.setCalendarPopup(True)
        self.dateEdit.setDate(QDate(2020, 1, 1))
        self.dateEdit_2 = QDateEdit(self.tab_3)
        self.dateEdit_2.setObjectName(u"dateEdit_2")
        self.dateEdit_2.setGeometry(QRect(1080, 380, 110, 26))
        ...
        self.label_66.setGeometry(QRect(650, 140, 251, 21))
        self.label_66.setFont(font)
        self.line_6 = QFrame(self.tab_3)
        self.line_6.setObjectName(u"line_6")
        self.line_6.setGeometry(QRect(650, 160, 341, 16))
        self.line_6.setFrameShape(QFrame.HLine)
        self.line_6.setFrameShadow(QFrame.Sunken)
        self.checkBox = QCheckBox(self.tab_3)
        self.checkBox.setObjectName(u"checkBox")
        self.checkBox.setGeometry(QRect(670, 380, 231, 23))
        self.pushButton_2 = QPushButton(self.tab_3)
        self.pushButton_2.setObjectName(u"pushButton_2")
        self.pushButton_2.setGeometry(QRect(660, 460, 261, 25))
        self.pushButton_3 = QPushButton(self.tab_3)
        self.pushButton_3.setObjectName(u"pushButton_3")
        self.pushButton_3.setGeometry(QRect(10, 460, 261, 25))
        ...
        self.comboBox.setGeometry(QRect(930, 420, 261, 25))
        ...
        self.verticalLayoutWidget_3.setGeometry(QRect(10, 10, 681, 80))
        ...
        self.pushButton_4.setGeometry(QRect(910, 80, 171, 25))
        self.pushButton_5 = QPushButton(self.tab_3)
        self.pushButton_5.setObjectName(u"pushButton_5")
        self.pushButton_5.setGeometry(QRect(1090, 80, 171, 25))
        self.tabWidget.addTab(self.tab_3, "")
        MainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QMenuBar(MainWindow)
        self.menubar.setObjectName(u"menubar")
        self.menubar.setGeometry(QRect(0, 0, 1318, 22))
        ...
        self.menuFile.addAction(self.actionExportar_tabla_actual_hacia_CSV)
        self.menuFile.addSeparator()
        ...
        self.menuCambiar_a.addAction(self.actionCelulares_2)
        self.menuCambiar_a.addAction(self.actionZapatos_2)
        self.menuCambiar_a.addAction(self.actionBisuteria)
...
#endif // QT_CONFIG(shortcut)
        self.actionCelulares_2.setText(QCoreApplication.translate("MainWindow", u"Celulares", None))
#if QT_CONFIG(shortcut)
        self.actionCelulares_2.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl+Shift+C", None))
#endif // QT_CONFIG(shortcut)
        self.actionZapatos_2.setText(QCoreApplication.translate("MainWindow", u"Zapatos", None))
#if QT_CONFIG(shortcut)
        self.actionZapatos_2.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl+Shift+Z", None))
#endif // QT_CONFIG(shortcut)
        self.actionBisuteria.setText(QCoreApplication.translate("MainWindow", u"Bisuteria", None))
#if QT_CONFIG(shortcut)
        self.actionBisuteria.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl+Shift+B", None))
#endif // QT_CONFIG(shortcut)
...
#endif // QT_CONFIG(shortcut)
        self.actionExportar_tabla_actual_hacia_CSV.setText(QCoreApplication.translate("MainWindow", u"Exportar tabla actual hacia archivo .CSV", None))
#if QT_CONFIG(shortcut)
        self.actionExportar_tabla_actual_hacia_CSV.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl+E", None))
#endif // QT_CONFIG(shortcut)
