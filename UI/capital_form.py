...
class Ui_DialogCapital(object):
    def setupUi(self, DialogCapital):
        ...
        self.buttonBox.setGeometry(QRect(10, 250, 511, 32))
        ...
        self.formLayoutWidget_2.setGeometry(QRect(8, 12, 511, 151))
        ...
        self.notasDeCapital.setGeometry(QRect(20, 180, 491, 51))
        font = QFont()
        font.setBold(True)
        font.setItalic(True)
        font.setWeight(75)
